...
public class Lwjgl3Window implements Disposable {
  ...
  public Object cljConfig;
	public long windowHandle;
	public final ApplicationListener listener;
	public final Array<LifecycleListener> lifecycleListeners;
	public boolean listenerInitialized = false;
  ...
  public HdpiMode hdpiMode;
	...
	public final GLFWWindowMaximizeCallback maximizeCallback = new GLFWWindowMaximizeCallback() {
		@Override
	...
	public final GLFWWindowCloseCallback closeCallback = new GLFWWindowCloseCallback() {
		@Override
	...
	public final GLFWDropCallback dropCallback = new GLFWDropCallback() {
		@Override
	...
	public final GLFWWindowRefreshCallback refreshCallback = new GLFWWindowRefreshCallback() {
		@Override
	...
	public Lwjgl3Window (ApplicationListener listener, Array<LifecycleListener> lifecycleListeners) {
	...
	public static void setIcon (long windowHandle, String[] imagePaths, Files.FileType imageFileType) {
	...
	public boolean update () {
      ...
      Clojure.var("com.badlogic.gdx.backends.lwjgl", "initializeListener").invoke(this);
		}
		synchronized (runnables) {
		...
		if (asyncResized) {
			asyncResized = false;
      Clojure.var("com.badlogic.gdx.backends.lwjgl", "update-framebuffer-info").invoke(graphics);
