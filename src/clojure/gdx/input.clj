...
(defn button-just-pressed? [^Input this button]
  (.isButtonJustPressed this (k->Input$Buttons button)))

(defn key-pressed? [^Input this key]
  (.isKeyPressed this (k->Input$Keys key)))

(defn key-just-pressed? [^Input this key]
  (.isKeyJustPressed this (k->Input$Keys key)))
