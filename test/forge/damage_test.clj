...
(deftest modify-source-damage
  (is (= (entity/damage {:entity/modifiers {:modifier/damage-deal-min {:op/inc 1
                                                                 :op/mult 50}}}
                  {:damage/min-max [5 10]})
         #:damage{:min-max [9 10]})))

(deftest modify-source-damage-align
  (is (= (entity/damage {:entity/modifiers {:modifier/damage-deal-min {:op/inc 20}}}
                  {:damage/min-max [5 10]})
         #:damage{:min-max [25 25]})))

(deftest modify-source-damage-align-negative
  (is (= (entity/damage {:entity/modifiers {:modifier/damage-deal-min {:op/mult -100}
